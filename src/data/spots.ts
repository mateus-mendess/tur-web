...
const mockReviews: SpotReview[] = [
  { id: 'r1', user: 'Camila R.', avatarUrl: '', rating: 5.0, text: 'Lugar incrível, vista de tirar o fôlego! Recomendo chegar cedo para evitar filas.' },
  { id: 'r2', user: 'Marcos T.', avatarUrl: '', rating: 4.8, text: 'Experiência única. A infraestrutura melhorou bastante nos últimos anos.' },
  { id: 'r3', user: 'Juliana P.', avatarUrl: '', rating: 5.0, text: 'Um dos melhores passeios que já fiz. Inesquecível a energia do local!' },
  { id: 'r4', user: 'Rafael M.', avatarUrl: '', rating: 4.5, text: 'Perfeito para fotos, mas vá preparado para andar bastante e levar água.' },
  { id: 'r5', user: 'Beatriz L.', avatarUrl: '', rating: 5.0, text: 'Atendimento e recepção muito amigáveis. Um cartão postal impecável.' },
  { id: 'r6', user: 'Diego S.', avatarUrl: '', rating: 4.9, text: 'Vista fantástica da cidade inteira. O por do sol aqui é incomparável.' },
  { id: 'r7', user: 'Fernanda K.', avatarUrl: '', rating: 4.7, text: 'Muito bem conservado e com boa sinalização para os visitantes.' },
  { id: 'r8', user: 'Gustavo H.', avatarUrl: '', rating: 5.0, text: 'Vale cada segundo da visita. Dica: compre os ingressos online com antecedência.' },
  { id: 'r9', user: 'Patrícia A.', avatarUrl: '', rating: 4.8, text: 'Experiência sensacional para levar toda a família!' },
  { id: 'r10', user: 'Leonardo F.', avatarUrl: '', rating: 5.0, text: 'Um verdadeiro patrimônio histórico e cultural. Fiquei deslumbrado.' }
];
...
export const FEATURED_SPOTS: Spot[] = [
  ...
  },
  {
    ...
    description: 'O Parque Nacional dos Lençóis Maranhenses é um paraíso ecológico com suas vastas dunas de areia branca e lagoas de água doce cristalina que se formam na época das chuvas. Um dos cenários mais exóticos e belos do mundo.',
  ...
  },
  {
    ...
    description: 'O Pelourinho é o coração histórico de Salvador. Suas ruas de paralelepípedos são cercadas por casarões coloniais coloridos e igrejas barrocas, muita música, cultura afro-brasileira e culinária típica.',
