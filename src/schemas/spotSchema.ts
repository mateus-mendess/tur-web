 ...
 * - `addressRequest` para conter os dados de endereço
 */
export const spotSchema = z.object({
  ...
  description: z.string().min(1, 'Por favor, informe uma breve descrição.'),
  ...
  accessibilityTypesIds: z.array(z.number().int()),
  addressRequest: z.object({
    zipcode: z
      .string()
      .min(1, 'Por favor, informe o CEP.')
      .regex(ZIPCODE_REGEX, 'CEP deve estar no formato 00000-000 ou 00000000.'),
    street: z.string().min(1, 'Por favor, informe a rua / logradouro.'),
    neighborhood: z.string().min(1, 'Por favor, informe o bairro.'),
...
export const editAddressSchema = spotSchema.shape.addressRequest
